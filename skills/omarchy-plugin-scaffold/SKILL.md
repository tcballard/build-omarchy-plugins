...
selecting optional flags, extending the output, arranging the compact README
badge row, or pairing badges with GitHub repository topics. For a shell plugin, recommend `omarchy` and
